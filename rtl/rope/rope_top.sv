module rope_top #(
    ...
    // ============================================================
    logic [15:0] head_buffer_in [0:HEAD_DIM-1];
    logic [15:0] head_buffer_out [0:HEAD_DIM-1];
    ...
    assign m_axis_tdata = head_buffer_out[tx_cnt];

    assign m_axis_tvalid = (state == ST_TRANSMIT);

    assign m_axis_tlast = (state == ST_TRANSMIT) && (tx_cnt == HEAD_DIM - 1);
            ...
            case (state)
                ...
                ST_RECEIVE: begin
                    ...
                    if ( s_axis_tvalid && s_axis_tready ) begin
                        ...
                        head_buffer_in[rx_cnt] <= s_axis_tdata;
                ...
                ST_PROCESS: begin
                    ...
                    if ( core_ready_in && !core_started ) begin
